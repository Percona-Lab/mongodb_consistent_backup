...
def config(parser):
	parser.add_argument("-uploader.method", dest="uploader.method", help="Uploader method (default: s3)", default='s3', choices=['s3','none'])
	parser.add_argument("-uploader.s3.threads", dest="uploader.s3.secret_key", help="S3 Uploader upload worker threads (default: 4)", default=4, type=int)
