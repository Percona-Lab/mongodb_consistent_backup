...
class ConfigParser(BaseConfiguration):
	def makeParser(self):
		...
		parser.add_argument("-m", "-method", dest="method", help="Method to be used for backup (default: mongodump)", default='mongodump', choices=['mongodump'])
		parser.add_argument("-H", "-host", dest="host", help="MongoDB Hostname/IP", default="localhost", type=str)
		parser.add_argument("-P", "-port", dest="port", help="MongoDB Port", port="27017", type=int)
