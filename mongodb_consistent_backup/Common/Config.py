...
class ConfigParser(BaseConfiguration):
    ...
    def makeParser(self):
        ...
        parser.add_argument("--ssl.enabled", dest="ssl.enabled", help="Use an SSL secured database connection (default: false)", default=False, type=bool)
        parser.add_argument("--ssl.validate", dest="ssl.validate", help="Validate the SSL certificate and hostname of the server (default: true)", default=True, type=bool)
        parser.add_argument("--ssl.ca_file", dest="ssl.ca_file", help="Path to SSL Certificate Authority file", default=None, type=str)
        ...
        parser.add_argument("--ssl.client_cert_file", dest="ssl.client_cert_file", help="Path to Client SSL Key file (for optional client ssl auth)", default=None, type=str)
        parser.add_argument("--ssl.client_key_file", dest="ssl.client_key_file", help="Path to Client SSL Certificate file (if not provided by client_cert_file, for optional client ssl auth)", default=None, type=str)
