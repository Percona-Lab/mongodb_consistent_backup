...
class ConfigParser(BaseConfiguration):
    ...
    def makeParser(self):
        ...
        parser.add_argument("--rotate.max_backup_days", dest="rotate.max_backup_days", help="Maximum age in days for backups in backup directory (default: disabled)", default=0, type=float)
